...
OTLP_GRPC_ENDPOINT: str = os.environ.get("OTLP_GRPC_ENDPOINT", "tempo:4317")
TARGET_ONE_HOST: str = os.environ.get("TARGET_ONE_HOST", "app-b")
TARGET_TWO_HOST: str = os.environ.get("TARGET_TWO_HOST", "app-c")
app: FastAPI = FastAPI()
...
async def random_sleep(response: Response) -> Dict[str, str]:
...
@app.get("/error_test")
async def error_test(response: Response) -> None:
    logging.error("got error!!!!")
    raise ValueError("value error")


@app.get("/chain")
async def chain(response: Response) -> Dict[str, str]:
